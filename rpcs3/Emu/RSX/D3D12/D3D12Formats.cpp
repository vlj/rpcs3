...
D3D12_BLEND get_blend_factor_alpha(u16 factor)
{
	...
	case CELL_GCM_SRC_ALPHA_SATURATE: return D3D12_BLEND_SRC_ALPHA_SAT;
	case CELL_GCM_CONSTANT_COLOR: return D3D12_BLEND_BLEND_FACTOR;
	case CELL_GCM_ONE_MINUS_CONSTANT_COLOR: return D3D12_BLEND_INV_BLEND_FACTOR;
	case CELL_GCM_CONSTANT_ALPHA: return D3D12_BLEND_BLEND_FACTOR;
	case CELL_GCM_ONE_MINUS_CONSTANT_ALPHA: return D3D12_BLEND_INV_BLEND_FACTOR;
	}
...
DXGI_FORMAT get_texture_format(u8 format)
{
	...
	case CELL_GCM_TEXTURE_A8R8G8B8: return DXGI_FORMAT_B8G8R8A8_UNORM;
...
namespace
{
	...
	D3D12_FILTER_TYPE get_mag_filter(u8 mag_filter)
	{
		...
		case 4: return D3D12_FILTER_TYPE_LINEAR; // Unknow filter
		}
...
DXGI_FORMAT get_color_surface_format(u8 format)
{
	...
	case CELL_GCM_SURFACE_A8R8G8B8: return DXGI_FORMAT_B8G8R8A8_UNORM;
