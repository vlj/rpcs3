...
{
	template<typename data_heap_specialisation>
	static size_t alloc_and_copy(data_heap_specialisation& data_heap_info, size_t size, std::function<void(gsl::span<gsl::byte> ptr)> copy_function)
	{
