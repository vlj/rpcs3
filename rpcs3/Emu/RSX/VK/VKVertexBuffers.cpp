...
namespace
{
	constexpr std::array<const char*, 16> reg_table =
	{
...
std::tuple<VkPrimitiveTopology, u32, std::experimental::optional<std::tuple<VkDeviceSize, VkIndexType> > >
VKGSRender::upload_vertex_data()
{
	...
	std::experimental::optional<std::tuple<VkDeviceSize, VkIndexType> > index_info;
...
void VKGSRender::upload_inlined_array()
{
	u32 stride = 0;
